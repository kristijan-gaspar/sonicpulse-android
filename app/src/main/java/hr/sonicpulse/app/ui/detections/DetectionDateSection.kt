 ...
 * (derived from the backend-authoritative `receivedAtUtc`, never `peakTimeClient`), left as a raw
 * value here; formatting it as "Today" vs. a localized date string is the Composable's job. */
